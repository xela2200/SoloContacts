...
namespace SoloContacts.Core.Data
{
    ...
    public class SafeDataReader : IDataReader
    {
        ...
        /// </remarks>
        /// <param name="name">Name of the column containing the value.</param>
        public SmartInt GetSmartInt(string name)
        {
        ...
        public SmartDate GetSmartDate(string name, bool minIsEmpty, string format)
        {
            return GetSmartDate(_dataReader.GetOrdinal(name), minIsEmpty, format);
        }
        /// <summary>
        /// Gets a <see cref="SmartInt" /> from the datareader.
        /// </summary>
        ...
        public SmartInt GetSmartInt(string name, bool minIsEmpty)
        {
            return GetSmartInt(_dataReader.GetOrdinal(name), minIsEmpty);
        }

        public virtual SmartInt GetSmartInt(int i, bool minIsEmpty)
        {
            if (_dataReader.IsDBNull(i))
                return new SmartInt(minIsEmpty);
            else
                return new SmartInt(
        ...
        public virtual SmartDate GetSmartDate(int i, bool minIsEmpty, string format)
        {
            if (_dataReader.IsDBNull(i))
            {
                return new SmartDate(minIsEmpty, format);
            }
            else
            {
                return new SmartDate(_dataReader.GetDateTime(i), minIsEmpty, format);
            }
